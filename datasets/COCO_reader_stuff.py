...
TRAIN_DIR = '/mnt/disk50/datasets/COCO/tf_records/stuff/train2017'
VALIDATION_DIR = '/mnt/disk50/datasets/COCO/tf_records/stuff/val2017'
...
def decode(serialized_example):
    ...
    features['label/encoded'] = tf.decode_raw(features['label/encoded'], tf.float64)
    ih = tf.cast(features['image/height'], tf.int32)
    iw = tf.cast(features['image/width'], tf.int32)
    features['label/encoded'] = tf.reshape(features['label/encoded'], [ih, iw, 1])
