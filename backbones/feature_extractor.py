...
def extract_features(images,
    ...
    if 'xception' in model_variant:
        net_arg_scope = arg_scopes_map[model_variant](
        ...
        features, end_points = get_network(
            model_variant, preprocess_images, net_arg_scope)(
            inputs=images,
...
def get_network(network_name, preprocess_images=False, net_arg_scope=None):
    """Gets the network.

    Args:
      network_name: Network name.
      preprocess_images: Preprocesses the images or not.
      net_arg_scope: Optional, arg_scope to build the network. If not provided the
    ...
    net_arg_scope = net_arg_scope or arg_scopes_map[network_name]()
